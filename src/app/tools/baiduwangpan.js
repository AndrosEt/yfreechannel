  ...
  function o() {
    ...
    function g() {
      ...
      n.append(l).append(d).append(r).append(c).append(o).append(p), e.append(i), t.append(e).append(n), t.hover(function () {
        t.toggleClass("button-open");
      }), o.click(_), s.click(A), l.click(F), c.click(B), d.click(B), r.click(G), p.click(k), $("div.module-share-top-bar div.bar div.x-button-box").append(t);
    }
    ...
    this.init = function () {
      ...
      e(), g(), bt = new c({addCopy: !1}), yt = new p(H, K), M(), S(), a() || U(), t("下载助手加载成功！当前版本：", h);
    };
  }
